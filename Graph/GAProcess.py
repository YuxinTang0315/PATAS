...
class GA():
	...
	def run(self, gen=50):
		...
		for n in range(1, gen+1):
			...
			with open("/home/ustbai/tangyuxin/self-supervised_learning/on_Graphs/Evolutionary_transformer_cls_graph/spearman_hiv.txt", "a+") as f:
			...
			if n % 1 == 0:
				with open('/home/ustbai/tangyuxin/self-supervised_learning/on_Graphs/Evolutionary_transformer_cls_graph/GA_result_hiv.txt','a+') as GA_result:
